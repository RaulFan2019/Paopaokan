 ...
 */
public class FriendInfoAdapter extends FragmentStatePagerAdapter {
    ...
    public FriendInfoAdapter(FragmentManager fm, Tab[] tabs) {
        super(fm);
        mTabs = tabs;
        ...
        try {
            ...
            if (mActive != null) {
                for (Fragment fragment : mActive) {
                    if (fragment instanceof FriendRankingNameFragment)
                        setFragment(Tab.FRIEND, fragment);
                    else if (fragment instanceof FriendRankingFragment)
    ...
    public Fragment getItem(int position) {
        if (mFragments[position] == null) {
            switch (mTabs[position]) {
                case FRIEND:
                    mFragments[position] = FriendRankingNameFragment.newInstance();
                    break;
                case RANK:
                    mFragments[position] = FriendRankingFragment.newInstance();
                    break;
            }
        }
