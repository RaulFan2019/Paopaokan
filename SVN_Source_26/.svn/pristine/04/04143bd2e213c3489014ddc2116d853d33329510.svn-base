 ...
 * @author Raul
 */
public class LiveSplitListAdapterV3 extends BaseAdapter {

    private static final String TAG = "HistoryInfoLapListAdapter";

    private LayoutInflater layoutInflater;
    private Activity activity;
    private List<LiveSplite> splits;
    private int maxTimeSpeed;// 最大配速
    private boolean hasHeartrate;// 是否有心率
    private Typeface typeFace;//字体

    public LiveSplitListAdapterV3(Activity activity, List<LiveSplite> splits, int maxTimeSpeed,
