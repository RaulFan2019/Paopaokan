...
public class Constants {
	...
	public static final float LAYOUT_WIDTH_OFFSET = 10;
	
	//----------------- separator Tag Item-----------------//
	public static final float DEFAULT_TAG_TEXT_SIZE = 10f;
	public static final float DEFAULT_TAG_DELETE_INDICATOR_SIZE = 10f;
	...
	public static final boolean DEFAULT_SHOW_TAG_IMG = false;
}
