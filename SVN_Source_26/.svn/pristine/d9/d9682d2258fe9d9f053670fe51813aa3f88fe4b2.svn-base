 ...
 * 配速的曲线
 */
public class LivePaceChartView extends DemoView {

    /* contains */
    private static final String TAG = "LivePaceChartView";
    ...
    /* Constructor */
    public LivePaceChartView(Context context) {
        super(context);
    }

    public LivePaceChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LivePaceChartView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param color
     */
    public void addLine(List<LivePlayBackLocEntityV2> mPlayList, int color, boolean draw) {
        ...
        for (int i = 0; i < mPlayList.size(); i += drawStep) {
            LivePlayBackLocEntityV2 location = mPlayList.get(i);
            double x = i;
        ...
        AreaData line = new AreaData("", heartratePoint,
                Color.parseColor("#f06522"), Color.parseColor("#80f06522"), Color.parseColor("#00f06522"));
        //不显示点
