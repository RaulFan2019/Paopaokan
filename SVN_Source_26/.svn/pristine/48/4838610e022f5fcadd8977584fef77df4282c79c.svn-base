...
//			Log.d(TAG, "Error: " + framework_err + "," + impl_err);
			...
			if (getWindowToken() != null) {
				 ...
				 * .setTitle(com.android.internal.R.string.
				 * VideoView_error_title) .setMessage(messageId)
				 * .setPositiveButton(com.android.internal.R.string.
				 * VideoView_error_button, new DialogInterface.OnClickListener()
				 * { public void onClick(DialogInterface dialog, int
				 * whichButton) { If we get here, there is no onError listener,
