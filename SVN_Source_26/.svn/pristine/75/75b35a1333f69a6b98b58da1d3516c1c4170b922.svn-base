...
public class SameFriendListActivity extends BaseAppCompActivity implements View.OnClickListener{

    /* contains */
    private static final String TAG = "SameFriendListActivity";
    ...
    private void PostGetFriendRequst() {
        ...
        String POST_URL = URLConfig.URL_GET_SAME_FRIEND;
        RequestParams params = RequestParamsBuild.buildGetSameFriendRequest(mContext,userId);
