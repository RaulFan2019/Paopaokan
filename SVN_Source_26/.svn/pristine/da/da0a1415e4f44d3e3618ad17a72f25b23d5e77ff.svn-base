 ...
 * 跑步历史 - 心率页面
 */
public class HistoryHeartrateInfoFragmentV2 extends BaseFragment implements View.OnClickListener {
    ...
    private DBEntityWorkout mHistoryInfo;// 跑步历史对象
    private List<DBEntityHeartrate> mheartrateList = new ArrayList<DBEntityHeartrate>();
    private List<DBEntityHeartrate> mDrawList = new ArrayList<DBEntityHeartrate>();
    ...
    private HeartRateChartViewReplace mLineChartView;
    private MyFriendHeartRateDountChartView mDountChartView;
    private MyFriendHeartRateDountBigChartView mBigDountChartView;

    public static HistoryHeartrateInfoFragmentV2 newInstance() {
        HistoryHeartrateInfoFragmentV2 fragment = new HistoryHeartrateInfoFragmentV2();
        return fragment;
    }
    ...
    public void updateViewFromActivity() {
        initData();
    ...
    private void setUpChartView() {
        ...
        mLineChartView = new HeartRateChartViewReplace(mContext);
    ...
    private void drawLineChartAnim() {
        for (int i = 0; i < mDrawList.size() - 3; ) {
            List<DBEntityHeartrate> tempList = new ArrayList<DBEntityHeartrate>();
            tempList = mDrawList.subList(i, i + 3);
            mLineChartView.addLine(tempList, getColorByHeartrate(tempList.get
                    (0).bmp), false);
            i = i + 2;
        }
        mLineChartView.addLine(new ArrayList<DBEntityHeartrate>(), Color.TRANSPARENT, true);
    }
    ...
    private void updateFouceView() {
        ...
        switch (mFocusStatus) {
            case FOCUS_STATUS_0_89:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight0_89 / 100));
            ...
            case FOCUS_STATUS_90_108:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight90_108 /
                        100));
            ...
            case FOCUS_STATUS_109_126:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight109_126 /
                        100));
            ...
            case FOCUS_STATUS_127_144:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight127_144 /
                        100));
            ...
            case FOCUS_STATUS_145_162:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight145_162 /
                        100));
            ...
            case FOCUS_STATUS_163_180:
                ...
                mTimeTv.setText(TimeUtils.formatDurationStr(mHistoryInfo.getDuration() * weight163_180 /
                        100));
    ...
    private void initData() {
        ...
        mHistoryInfo = activity.getDBWorkout();
        mAge = TimeUtils.getAgeFromBirthDay(LocalApplication.getInstance().getLoginUser(mContext).getBirthday());
        mheartrateList = HeartrateData.getAllHeartrateFromWork(mContext, mHistoryInfo.getName());

        if (mheartrateList == null || mheartrateList.size() == 0) {
            return;
        }

        minHeartrate = mheartrateList.get(0).bmp;
