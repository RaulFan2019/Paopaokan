...
import com.app.pao.fragment.settings.MultiImageSelectorFragment;
 ...
 * 多图选择展示
 */
@ContentView(R.layout.activity_multiimage_selector)
public class MultiImageSelectorActivity extends BaseAppCompActivity implements MultiImageSelectorFragment.Callback {
