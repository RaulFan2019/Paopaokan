package com.app.pao.ui.widget.pulltozoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    private ShowTitleColorListener mListener;
...
//                    Log.d(TAG, "onScrollChanged --> getScrollY() = " + mRootView.getScrollY());
                    if (mListener != null) {
                        mListener.scrollYChange(mRootView.getScrollY());
                    }
//                    if (mRootView.getScrollY() > 600) {
//                        if (mListener != null) {
//                            mListener.showTitle();
//                        }
//                    } else {
...
//                    Log.d(TAG, "onScrollChanged --> f = " + f);
    ...
    public interface ShowTitleColorListener{
//        void showTitle();
//        void hideTitle();
        void scrollYChange(int y);
    }

    public void setShowTitleColorListener(ShowTitleColorListener mListener){
