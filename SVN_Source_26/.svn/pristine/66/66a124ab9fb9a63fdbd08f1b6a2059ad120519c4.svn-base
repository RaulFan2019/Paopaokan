 ...
 * 好友历史的曲线
 */
public class MyFriendHeartRateChartViewReplace extends DemoView {

    /* contains */
    private static final String TAG = "MyFriendHeartRateChartViewReplace";
    ...
    /* Constructor */
    public MyFriendHeartRateChartViewReplace(Context context) {
        super(context);
    }

    public MyFriendHeartRateChartViewReplace(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyFriendHeartRateChartViewReplace(Context context, AttributeSet attrs, int defStyle) {
