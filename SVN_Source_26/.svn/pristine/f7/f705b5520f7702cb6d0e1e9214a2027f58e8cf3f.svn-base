package hwh.com.pickviewlibrary.lib;
...
import hwh.com.pickviewlibrary.R;
import hwh.com.pickviewlibrary.adapter.WheelAdapter;
import hwh.com.pickviewlibrary.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.wheelview_gravity, Gravity.LEFT);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (label != null) {
            ...
            //靠右并留出空隙
//            Paint paintLabelText = paintCenterText;
//            paintLabelText.setTextSize(context.getResources().getDisplayMetrics().density * 10);
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = (int) (context.getResources().getDisplayMetrics().density * 5);
                break;
            case Gravity.RIGHT:
                drawCenterContentStart = measuredWidth - (int) (context.getResources().getDisplayMetrics().density * 5) - rect.width();
                break;
        }
    }
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = (int) (context.getResources().getDisplayMetrics().density * 5);
                break;
            case Gravity.RIGHT:
                drawOutContentStart = measuredWidth - (int) (context.getResources().getDisplayMetrics().density * 5) - rect.width();
                break;
        }
    }
