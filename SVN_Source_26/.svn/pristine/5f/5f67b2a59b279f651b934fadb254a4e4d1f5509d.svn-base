...
//                namespace, "slideUnlockBackgroundResource", -1);
        ...
        int slideUnlockBackgroundResource = R.drawable.bg_jiesuo;
        // 取出自定义属性中滑块图片
//        int slideUnlockBlockResource = attrs.getAttributeResourceValue(
//                namespace, "slideUnlockBlockResource", -1);
        int slideUnlockBlockResource = R.drawable.ic_lock;
...
//		Log.i(TAG, "setSlideUnlockBlock.....");
        ...
        // 获取滑块的宽和高
        blockWidth = (int) DeviceUtils.dpToPixel(46);
        blockHeight = (int) DeviceUtils.dpToPixel(46);
    }
