package hwh.com.pickviewlibrary.view;
...
import hwh.com.pickviewlibrary.adapter.ArrayWheelAdapter;
import hwh.com.pickviewlibrary.lib.WheelView;
...
public class WheelOptions<T> {
    ...
    public void setPicker(ArrayList<T> options1Items,
        ...
        if (mOptions2Items != null)
            wv_option2.setAdapter(new ArrayWheelAdapter(mOptions2Items.get(wv_option1.getCurrentItem())));// 设置显示数据
        wv_option2.setCurrentItem(wv_option2.getCurrentItem());// 初始化时显示的数据
        // 选项3
        wv_option3 = (WheelView) view.findViewById(R.id.options3);
        if (mOptions3Items != null)
            wv_option3.setAdapter(new ArrayWheelAdapter(mOptions3Items.get(wv_option1.getCurrentItem())
                    .get(wv_option2.getCurrentItem())));// 设置显示数据
