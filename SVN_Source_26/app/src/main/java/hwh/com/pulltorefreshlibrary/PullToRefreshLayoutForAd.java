package hwh.com.pulltorefreshlibrary;
 ...
 * @author 陈靖
 */
public class PullToRefreshLayoutForAd extends RelativeLayout {
    ...
    public PullToRefreshLayoutForAd(Context context) {
        super(context);
        initView(context);
    }

    public PullToRefreshLayoutForAd(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PullToRefreshLayoutForAd(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        Log.v(TAG, "adView.getBottom():" + adView.getBottom());
        if (ev.getY() < adView.getBottom()

//                && state != RELEASE_TO_LOAD
//                && ev.getActionMasked() == MotionEvent.ACTION_MOVE
        ){
            Log.v(TAG, "adView.dispatchTouchEvent");
            adView.dispatchTouchEvent(ev);
//            super.dispatchTouchEvent(ev);
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(PullToRefreshLayoutForAd.this);
            hide();
        }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(PullToRefreshLayoutForAd pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullToRefreshLayoutForAd pullToRefreshLayout);
    }
