 ...
 */
public class GroupMemberRankingTotalAdapter extends RecyclerView.Adapter<GroupMemberRankingTotalAdapter.RankingHolder>{
    private List<GetGroupMemberSortResult> mRankingList ;
    private BitmapUtils bitmapUtils;
    private GetGroupDetailInfoRequest mGroupInfo;
    private Context mContext;

    public GroupMemberRankingTotalAdapter(Context context, GetGroupDetailInfoRequest mGroupInfo, List<GetGroupMemberSortResult> mRankingList) {
