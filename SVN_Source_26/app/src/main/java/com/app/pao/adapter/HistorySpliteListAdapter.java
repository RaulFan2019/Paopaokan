 ...
 * @author Raul
 */
public class HistorySpliteListAdapter extends BaseAdapter {

    private static final String TAG = "HistoryInfoLapListAdapter";

    private LayoutInflater layoutInflater;
    private Activity activity;
    private List<DBEntitySplite> splits;
    ...
    public HistorySpliteListAdapter(Activity activity, List<DBEntitySplite> splits, int maxTimeSpeed,
