 ...
 */
public class LiveSocialViewHolderV3 extends RecyclerView.ViewHolder {
    ...
    public LiveSocialViewHolderV3(View itemView, int itemType) {
        super(itemView);
    ...
    public void bindItem(final Context context, final LiveSocial entity, final BitmapUtils mBtimapUtils) {
        //same ui
        ImageUtils.loadUserImage( entity.useravatar, mAvatarIv);
        mNickNameTv.setText(entity.usernickname);
        String socialLoc = NumUtils.retainTheDecimal(entity.position) + "公里" + "  " +
                TimeUtils.getTimestampString(TimeUtils.stringToDate(entity.time));
            ...
            public void onClick(View v) {
                ...
                if (entity.getUserid() == LocalApplication.getInstance().getLoginUser(context).userId) {
                    ...
                    mCurrCommentEnvent = new EventComment(getAdapterPosition(), entity.latitude, entity.longitude,
                            entity.userid, entity.usernickname, 1, entity.useravatar, "");
                }
