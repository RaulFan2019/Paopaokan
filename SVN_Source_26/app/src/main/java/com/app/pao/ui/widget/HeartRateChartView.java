...
public class HeartRateChartView extends DemoView {
    ...
    private List<DBEntityHeartrate> mHeartrateList;
    ...
    public void initView(List<DBEntityHeartrate> mheartrateList, int avgHeartrate ,int age) {
    ...
    private void chartLineRender() {
        try {
            ...
            splineChart.getDataAxis().setAxisMin(40);
            // 数据轴刻度间隔
            splineChart.getDataAxis().setAxisSteps(80);
    ...
    private void chartLineDataSet() {
        ...
        for (int i = 0; i < mHeartrateList.size(); i += mHeartrateStep) {
            DBEntityHeartrate heartrate = mHeartrateList.get(i);
        ...
        if (mHeartrateList.size() != 0) {
            DBEntityHeartrate firstHeartrate = mHeartrateList.get(0);
            DBEntityHeartrate lastHeartrate = mHeartrateList.get(mHeartrateList.size() - 1);
