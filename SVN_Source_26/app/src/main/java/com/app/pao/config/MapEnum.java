...
public class MapEnum {
    ...
    //大小
    public static final float WIDTH_POLYLINE = DeviceUtils.dpToPixel(5);//轨迹宽度


    //颜色
    public static final int COLOR_POLYLINE = Color.parseColor("#ffc445");
    public static final int COLOR_RUNNING_POLYLINE = Color.parseColor("#6889ff");
    ...
    //字体
    public static final int FONT_SIZE_SPLITE = (int)DeviceUtils.dpToPixel(10);
    public static final int STROKE_WIDTH_SPLITE = (int)DeviceUtils.dpToPixel(2);
}
