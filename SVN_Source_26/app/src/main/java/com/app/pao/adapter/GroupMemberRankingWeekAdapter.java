 ...
 */
public class GroupMemberRankingWeekAdapter extends RecyclerView.Adapter<GroupMemberRankingWeekAdapter.RankingHolder>{
    private List<GetGroupMemberSortResult> mRankingList ;
    private BitmapUtils bitmapUtils;
    private GetGroupDetailInfoRequest mGroupInfo;
    private Context mContext;

    public GroupMemberRankingWeekAdapter(Context context, GetGroupDetailInfoRequest mGroupInfo, List<GetGroupMemberSortResult> mRankingList) {
