 ...
 * 好友历史的曲线
 */
public class HeartRateChartViewReplace extends DemoView {
    ...
    /* Constructor */
    public HeartRateChartViewReplace(Context context) {
        super(context);
    }

    public HeartRateChartViewReplace(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeartRateChartViewReplace(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param color
     */
    public void addLine(List<DBEntityHeartrate> mHeartrateList, int color , boolean draw) {
