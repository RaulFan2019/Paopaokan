 ...
 */
public class GroupPartyListAdapterReplace extends RecyclerView.Adapter<GroupPartyListAdapterReplace.MyPartyHolder> {
    ...
    public GroupPartyListAdapterReplace(Context mContext, List<GetDynamicListResult.Party> mPartyDataList) {
    ...
    public MyPartyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group_my_party_replace, parent,
                false);
